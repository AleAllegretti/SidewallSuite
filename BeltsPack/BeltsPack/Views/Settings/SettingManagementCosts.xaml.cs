...
{
    /// <summary>
    /// Interaction logic for SettingManagementCosts.xaml
    /// </summary>
    public partial class SettingManagementCosts : Page
    {
        SqlDataAdapter dataAdapter;
        DataSet DataSet;
        Boolean TabellaModificata = false;
        public SettingManagementCosts()
        {
            InitializeComponent();
            ...
            SqlCommand creacomando = databaseSQL.CreateSettingCostiGestioneCommand();
