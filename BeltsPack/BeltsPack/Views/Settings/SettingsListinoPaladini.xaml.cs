...
{
    /// <summary>
    /// Interaction logic for SettingsListinoPaladini.xaml
    /// </summary>
    public partial class SettingsListinoPaladini : Page
    {
        SqlDataAdapter dataAdapter;
        DataSet DataSet;
        Boolean TabellaModificata = false;
        public SettingsListinoPaladini()
        {
            InitializeComponent();
            ...
            SqlCommand creacomando = databaseSQL.CreateSettingPaladiniCommand();
